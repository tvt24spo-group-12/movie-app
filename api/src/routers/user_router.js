...
import {getProfilePictureById,uploadProfilePicture} from '../controllers/profilePicture_controller.js'
...
userRouter.post("/profilePicture/:userId",authenticateToken, uploadProfilePicture)
